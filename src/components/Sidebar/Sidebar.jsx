...
const Sidebar = ({page, setPage}) => {
    return (
        <aside className="sidebar">
            ...
            <nav className="nav">
                <button onClick={() => setPage('board')} className={ `nav-link${page === "board" ? " active" : ""
                }` } data-page="board">
                ...
                <button onClick={() => setPage('people')} className={ `nav-link${page === "people" ? " active" : ""
                }` } data-page="people">
                    <span className="nav-icon">
                        <svg
                            viewBox="0 0 24 24"
                ...
                <button onClick={() => setPage('activity')} className={ `nav-link${page === "activity" 
                ? " active" : ""
                }` } data-page="activity">
